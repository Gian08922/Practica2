...
public class ZonasBasicasSalud2 {
    ...
    public ZonasBasicasSalud2() {

    }
    //SimpleDateFormat formato = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");

    public ZonasBasicasSalud2(String codigo_geometria, String zona_basica_salud, Float tasa_incidencia_acumulada_P60mas_ultimos_14dias, Float casos_confirmados_P60mas_ultimos_14dias, String fecha_informe)  {
