...
public class MainView extends VerticalLayout {
    ...
    public MainView(@Autowired ZonasBasicasSaludService service) {
        ...
        grid.addItemDoubleClickListener(e->{
            ...
            Button confirmar= new Button("Confirmar",
                    confirmacion->{
                        ...
                        modificado.setCodigo_geometria(String.valueOf(codigoDeGeometria.getValue()));
                        modificado.setZona_basica_salud(String.valueOf(zonaBasicaSalud.getValue()));
                        ...
                        modificado.setFecha_informe(String.valueOf(fechaDeInforme.getValue()));


                        try {
                            service.Put(modificado, String.valueOf(codigoDeGeometria.getValue()));
        ...
        grid2.addItemDoubleClickListener(e2->{
            ...
            Button confirmar2= new Button("Confirmar",
                    confirmar->{
                        ...
                        ZonasBasicasSalud2 modificado2 = new ZonasBasicasSalud2();

                        modificado2.setCodigo_geometria(String.valueOf(codigoDeGeometria.getValue()));
                        modificado2.setZona_basica_salud(String.valueOf(zonaBasicaSalud.getValue()));
                        modificado2.setTasa_incidencia_acumulada_P60mas_ultimos_14dias(Float.parseFloat(tasaincidencia14.getValue()));
                        modificado2.setCasos_confirmados_P60mas_ultimos_14dias(Float.parseFloat(tasainicidenciatotal.getValue()));
                        modificado2.setFecha_informe(String.valueOf(fechaDeInforme.getValue()));


                        try {
                            service.Put2(modificado2, String.valueOf(codigoDeGeometria.getValue()));
        ...
        Button botongrid1 = new Button("Mostrar",
                mostrar1 -> {
        ...
        Button botongrid2 = new Button("Mostrar",
                mostrar2 -> {
 ...
 */
       ...
       //add(inputs, boton1,botontabla, results, grid, grid2,crearnuevo);
        ...
        pestana.add("Primera tabla",new Div(inputs,results,crearnuevo,botongrid1));


        pestana.add("Segunda tabla",new Div(input2,result2,crearnuevo2,botongrid2));
