...
public class ZonasBasicasSaludService implements Serializable {
    ...
    public List<ZonasBasicasSalud> Post(ZonasBasicasSalud salud) throws URISyntaxException, IOException, InterruptedException {
        ZonasBasicasSaludAPI api = new ZonasBasicasSaludAPI();
        List<ZonasBasicasSalud> updatedSalud = api.PostCaso(salud);
        return updatedSalud;
    }
    ...
    public List<ZonasBasicasSalud2> Post2(ZonasBasicasSalud2 salud) throws URISyntaxException, IOException, InterruptedException {
        ZonasBasicasSaludAPI api = new ZonasBasicasSaludAPI();
        List<ZonasBasicasSalud2> updatedSalud = api.PostCaso2(salud);
        return updatedSalud;
    }



    public List<ZonasBasicasSalud2> Put2(ZonasBasicasSalud2 salud, String codigo) throws URISyntaxException, IOException, InterruptedException {
        ZonasBasicasSaludAPI api = new ZonasBasicasSaludAPI();
        List<ZonasBasicasSalud2> updatedSalud = api.PutCaso2(salud, codigo);
        return updatedSalud;
    }
